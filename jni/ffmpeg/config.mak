...
MY_TOOLCHAINS=/opt/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64
MY_PLATFORM=/opt/android-ndk-r12b/platforms/android-19
ifndef FFMPEG_CONFIG_MAK
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-static --enable-shared --enable-gpl --enable-version3 --enable-nonfree --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-avdevice --disable-avfilter --enable-small --cross-prefix=$(MY_TOOLCHAINS)/bin/arm-linux-androideabi- --enable-cross-compile --target-os=linux --extra-cflags=-I$(MY_PLATFORM)/arch-arm/usr/include --extra-ldflags='-L$(MY_PLATFORM)/arch-arm/usr/lib -nostdlib' --arch=arm --disable-debug --disable-stripping
prefix=/usr/local
...
CC_IDENT=gcc 4.9 (GCC)
ARCH=arm
CC=$(MY_TOOLCHAINS)/bin/arm-linux-androideabi-gcc
CXX=$(MY_TOOLCHAINS)/bin/arm-linux-androideabi-g++
AS=$(MY_TOOLCHAINS)/bin/arm-linux-androideabi-gcc
LD=$(MY_TOOLCHAINS)/bin/arm-linux-androideabi-gcc
DEPCC=$(MY_TOOLCHAINS)/bin/arm-linux-androideabi-gcc
YASM=yasm
YASMDEP=yasm
AR=$(MY_TOOLCHAINS)/bin/arm-linux-androideabi-ar
RANLIB=$(MY_TOOLCHAINS)/bin/arm-linux-androideabi-ranlib
CP=cp -p
LN_S=ln -sf
STRIP=echo skipping strip
CPPFLAGS= -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600
CFLAGS= -I$(MY_PLATFORM)/arch-arm/usr/include  -std=c99 -fomit-frame-pointer -marm -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize 
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS= -I$(MY_PLATFORM)/arch-arm/usr/include 
AS_O=-o $@
CC_O=-o $@
CXX_O=-o $@
LDFLAGS= -L$(MY_PLATFORM)/arch-arm/usr/lib -nostdlib -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
...
CONFIG_H264_CEDARX_DECODER=yes
